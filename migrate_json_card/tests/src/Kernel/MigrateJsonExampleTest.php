...
final class MigrateJsonExampleTest extends MigrateDrupalTestBase {
  ...
  protected function setUp(): void {
    ...
    \Drupal::service('module_installer')->install(['migrate_json_particle_example']);
    $this->installConfig(['migrate_json_particle_example']);
  }
  ...
  public function testMigrations(): void {
    ...
    // Execute "particle" migration from 'migrate_json_example' module.
    $this->executeMigration('particle');
  ...
  public function testModuleCleanup(): void {
    ...
    \Drupal::service('module_installer')->uninstall(['migrate_json_page_example']);
    ...
    \Drupal::service('module_installer')->install(['migrate_json_page_example']);
  }
